  ...
  $('button').click(() => {
    ...
    for (let i = 0; i < text.length; i++) {
      ...
      if (isKanji(c)) {
        ...
        if (isSurrogate(c) && isCheckShikaru(d))
          klass.push("shikaru");
    ...
    function isJitaiKakunin(c) {
      return /^[嘘焔侠躯繋屡蝉箪掴顛嚢溌醗倶呑唖鴎噛鹸麹繍醤掻祷蝋屏填剥頬𩜙芦頴撹蒋桝并弯沪鯵鴬蛎潅諌頚賎騨壷梼涛涜迩蝿桧侭薮莱篭埓妍尓懴攅昿檪畴筝臈軣鈬喻彚﨔渗䇳𨦇逸羽益謁禍悔海慨喝褐漢館器既祈響勤謹穀殺祉視飼煮社者臭祝暑署諸祥神晴精節曾祖僧層憎贈瀧琢嘆猪著懲塚禎都燈突難梅繁飯卑碑賓頻敏侮福塀勉墨免祐欄隆龍虜類練廊朗乘亂豫亞佛來假會傳僞價儉兒兔兩處剩劍劑辨勞勳勵勸區卷參雙單營嚴囑圈國圍圓團圖壞墮壓壘壤壯壹壽奧奬孃學實寢寫寶將專對屆屬峽嶽巖帶廣廢廳彈彌徑從恆惡惠惱愼慘應懷戀戰戲拔擔拜拂挾搜搖攝據擇擧擴收效敕敍數變斷晝曉霸條棧榮樂權樞樣樓檢櫻盜飮歐歡歸殘殼毆氣沒淨淺滿溪滯澁潛澤濟濕濱灣燒爐爭爲犧狹默獨獸獵獻瓣畫當疊癡發盡眞碎祕祿齋禪禮稱稻穗穩穰竊竝粹絲經總縣縱繪繩繼續纖缺罐飜聲聽肅腦膽臟臺與舊舍舖艷莖莊萬藏藝藥號螢蟲蠶蠻衞裝襃覺覽觀觸謠證譯譽讀讓豐貳賣贊踐輕轉辭辯遞隨遲邊醉醫釀釋錢鎭鐵鑄鑛關陷險隱雜靈靜顏顯餘餠騷驅驛驗髓體髮鬪鷄鹽麥點黨齊齒齡龜堯槇遙倂內卽吳吿增姬娛寬尙巢徵德悅戶戾揭揷擊敎晚曆槪橫步歲歷每涉淚淸渴溫瀨狀甁產瘦硏稅絕綠緖緣脫薰虛說賴郞鄕銳錄鍊閱靑麵黃黑欝薗駈渚嶋祢埜盃冨峯亙兔册凉凛卉插晄眞萠鼡﨑旣昻𥡴荆𨻶髙鬭閠栅]+$/.test(c);
    }
    ...
    function isJikken(c) {
      // return /^[\u{20B9F}]+$/.test(c);
      return /^[𠮟𠀋𡈽𡢽𡚴𣝣𥝱𨏍𧦅𧮾𨥫𪐷]+$/.test(c);
    }
