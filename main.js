...
$(() => {
  ...
  $('button').click(() => {
   ...
   // ★以下で、標準的な字体を表示する
    ...
    // ★以下は、文字色設定
    let out2 = jQuery("#output");
    out2.empty();

    for (let i = 0; i < out1.length; i++) {

      let c = out1.slice(i,i+1);
      let d = out1.slice(i+1,i+2);
      let klass = [], year;
     ...
     if (c === "\n") {
      ...
      $("<span/>")
        .text(c).addClass(klass.join(" ")).appendTo(out2);
